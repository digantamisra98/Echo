...
rinoh_documents = [
    (
        ...
        "HLTAPI",  # output (target.pdf)
        "Spirent TestCenter Automation HLTAPI Command Reference",  # document title
        "XTAPI",
    )
]  # document author
...
man_pages = [(master_doc, "echoAI", "EchoAI Documentation", [author], 1)]
...
# Exclude imports
autodoc_mock_imports = ["torch", "Keras", "tensorflow", "keras"]
