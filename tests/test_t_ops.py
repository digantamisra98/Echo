...
TEST_SWISH = [
    ...
    torch.tensor(
        [
            [
                [
                    [-4.54e-04, -2.68e-03, -1.48e-02, -7.19e-02, -2.38e-01],
                    [0.00e00, 1.76e00, 3.93e00, 5.99e00, 8.00e00],
                ]
            ]
        ]
    ),
...
TEST_MISH = [
    ...
    torch.tensor(
        [
            [
                [
                    [-4.54e-04, -2.68e-03, -1.49e-02, -7.26e-02, -2.53e-01],
                    [0.00e00, 1.94e00, 4.00e00, 6.00e00, 8.00e00],
                ]
            ]
        ]
    ),
...
class TestActivations(unittest.TestCase):
    @parameterized.expand([TEST_SWISH, TEST_MISH, TEST_BRELU])
